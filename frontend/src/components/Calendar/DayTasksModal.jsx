...
import { FaTimes, FaUser, FaCalendar, FaFlag, FaCircle } from "react-icons/fa";
import { useTranslation } from "react-i18next";

const DayTasksModal = ({ isOpen, onClose, selectedDate, tasks }) => {
  ...
  const formatDate = (date) => {
    if (isRTL) {
      // تبدیل تاریخ به شمسی برای نمایش در حالت فارسی
